ref ZenTreasureConfig g_ZenTreasureConfig;

static ZenTreasureConfig GetZenTreasureConfig()
{
	if (!g_ZenTreasureConfig) GetZenConfigRegister().RegisterConfig(ZenTreasureConfig);
	return g_ZenTreasureConfig;
}
...
modded class ZenConfigRegister
{
	override void RegisterPreload()
	{
		...
		RegisterType(ZenTreasureConfig);
	}
}

class ZenTreasureConfig: ZenConfigBase
{
	...
	{
		return JsonFileLoader<ZenTreasureConfig>.LoadFile(path, this, err);
	}

	override bool WriteJson(string path, out string err)
	{
		return JsonFileLoader<ZenTreasureConfig>.SaveFile(path, this, err);
	}

	//! CONFIG
	bool DebugZenMapCompatibility;
	bool DebugTeleportToPhoto;
	...
	{
		DebugZenMapCompatibility = false;
		DebugTeleportToPhoto = false;
		...
		TreasureTypes.Insert(new ZenTreasureStashType("Generic_Small", "#STR_CfgVehicles_ZenTreasure_category_valuable", "ZenTreasure_WoodenCrate"));

		// 1 - Generic loot large (sea chest) - filled with all possible loot from other configs
		TreasureTypes.Insert(new ZenTreasureStashType("Generic_Large", "#STR_CfgVehicles_ZenTreasure_category_valuable", "ZenTreasure_SeaChest"));

		// 2 - Hunting loot (wooden crate)
		ZenTreasureStashType huntingLootSmall = new ZenTreasureStashType("HuntingLoot_Small", "#STR_CfgVehicles_ZenTreasure_category_hunting", "ZenTreasure_WoodenCrate");
		...
		ZenTreasureStashType basebuildingLootSmall = new ZenTreasureStashType("Basebuilding_Small", "#STR_CfgVehicles_ZenTreasure_category_basebuilding", "ZenTreasure_WoodenCrate");
		...
		ZenTreasureStashType militaryLootSmall = new ZenTreasureStashType("Military_Small", "#STR_CfgVehicles_ZenTreasure_category_military", "ZenTreasure_WoodenCrate");
		...
		ZenTreasureStashType militaryLootLarge = new ZenTreasureStashType("Military_Large", "#STR_CfgVehicles_ZenTreasure_category_highgrade", "ZenTreasure_SeaChest");
		...
		// 6 - Medical
		ZenTreasureStashType medicalLootSmall = new ZenTreasureStashType("Medical_Small", "#STR_CfgVehicles_ZenTreasure_category_medical", "ZenTreasure_SeaChest");
